...
class Runner:
    def __init__(self,
        ...
        self.model_hyperparams = {'input_dim': input_dim,
    ...
    def run(self):
        ...
        wandb.init(
            project=self.project_name, config=all_param_dict, name=f"FNO_{self.model_hyperparams['d_model']}")
        ...
        model = FNOModule(**self.model_hyperparams)
