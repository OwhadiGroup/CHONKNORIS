#!/bin/bash
#SBATCH --job-name=test1d       # Name of the job
...
#SBATCH --time=00:10:00                # Maximum runtime for each job (hh:mm:ss)
...
python ../../test_plot_scripts/1d_test_plots.py --id $SLURM_ARRAY_TASK_ID